...
public class YoCycloidPlatinumTwitterOld implements YoGenericTwitter, ElmoTwitterDeviceStatusProvider
{
   ...
   private final CycloidPlatinumTwitterOld platinumTwitter;
   ...
   public YoCycloidPlatinumTwitterOld(String prefix,
                                      CycloidPlatinumTwitterOld twitter,
                                      DoubleProvider time,
   ...
   {
      return getMeasuredMotorPosition();
   }
   ...
   public CycloidPlatinumTwitterOld getPlatinumTwitter()
   {
