...
import us.ihmc.xmlToolkit.XmlHardwareDescription;
import us.ihmc.xmlToolkit.devices.XmlDevices;
import us.ihmc.xmlToolkit.devices.XmlEncoder;
import us.ihmc.xmlToolkit.devices.XmlH4EtherCATJunctionPort;
import us.ihmc.xmlToolkit.devices.XmlIMU;
import us.ihmc.xmlToolkit.devices.XmlIMUType;
import us.ihmc.xmlToolkit.devices.XmlLoadCell;
import us.ihmc.xmlToolkit.devices.XmlPlatinumTwitter;
import us.ihmc.xmlToolkit.devices.XmlTemperatureSensor;
import us.ihmc.xmlToolkit.joints.XmlJoints;
import us.ihmc.xmlToolkit.transmissions.XmlCycloidMotorMechanism;
